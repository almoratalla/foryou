import { Schema$ChannelListItem } from "./Schema$ChannelListResponse";
import { Schema$ItemSnippetThumbnails } from "./Schema$Response";
import { Schema$SubscriberListItemSnippet, Schema$SubscriberListItemContentDetails } from "./Schema$SubscriptionListResponse";

// Profile
export type Schema$ProfileItems = {
    id: string;
    videoId?: string;
    title: string;
    thumbnail: string;
...
export type Schema$ProfileLists = {
    totalResults: number;
...
export type Schema$PlaylistItem = {
    kind: string;
    etag: string;
    items: {
        kind: string;
...
export type Schema$ChannelItems = {
    kind?: string;
    etag?: string;
    id?: string;
    snippet?: {
...
export type Schema$ChannelList = Schema$Channel[];
export type Schema$PlaylistItemList = Schema$PlaylistItem[];

export type Error$OAuthError = {
    error: {
        code: number;
        errors: {
            domain: string;
...
export type Schema$Subscriptions = {
    nextPageToken: string;
