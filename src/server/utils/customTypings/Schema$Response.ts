...
export type Schema$Items = Schema$Item[];
...
export type Schema$ItemSnippetThumbnails = {
...
export type Schema$ItemStatistics = {
...
export type Schema$ItemBrandingSettings = {
    channel: {
        title: string;
        description: string;
        keywords: string;
